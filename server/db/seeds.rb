...
Article.create(title: "Type analysis for JavaScript", authors: "SH Jensen, A Møller, P Thiemann", language: "English", keywords: "javascript, types", content: "https://cs.au.dk/~amoeller/papers/tajs/paper.pdf", flagged: true, project: javascript_project) 
Article.create(title: "The essence of JavaScript", authors: "A Guha, C Saftoiu, S Krishnamurthi", language: "Javascript", keywords: "javascript", content: "https://arxiv.org/pdf/1510.00925", flagged: true, project: javascript_project) 
Article.create(title: "Sportification of Esports-A systematization of sport-teams entering the esports ecosystem", authors: "T Scholz, L Völkel, C Uebach", language: "English", keywords: "esports, valorant", content: "https://www.ijesports.org/article/48/html", flagged: false, project: javascript_project) 
